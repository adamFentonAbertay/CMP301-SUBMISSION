...
void BloomShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void BloomShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture, float cutoff)
{
	HRESULT result;
	...
	bloomPtr->cutoff = cutoff;
	bloomPtr->padding = XMFLOAT3(1.0f, 1.f, 1.f);
