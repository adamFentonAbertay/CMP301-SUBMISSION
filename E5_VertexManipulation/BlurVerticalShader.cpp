...
{
	initShader(L"blurVertical_vs.cso", L"blurVertical_ps.cso");
}
...
void BlurVerticalShader::initShader(const wchar_t* vsFilename, const wchar_t* psFilename)
{
...
void BlurVerticalShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture, float height)
{
